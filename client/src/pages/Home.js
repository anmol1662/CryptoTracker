...
// import { useState, useEffect } from "react"; // useEffect is a callback
...
const Home = () => {
  ...
  return (
    // <Cards data={a}/>
    // <Cards a={4} b={5} c={6} d={7} e={8}/>
    // <div>
    //     <button onClick={increase}>Example: {example}</button>
    // </div>
    <>
      <div>
          ...
          <section className="pt-20 md:pt-40">
            <div className="container mx-auto px-8 lg:flex">
              <div className="text-center lg:text-left lg:w-1/2">
                <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">CryptoTracker</h1>
                <p className="text-xl lg:text-2xl mt-6 font-light">
                  Your ultimate tool for tracking cryptocurrency prices, market trends, and portfolio performance. Stay informed and make smarter investment decisions with real-time data and insights.
                </p>
              ...
              <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                      Monitor live prices of your favorite<br/>
                      cryptocurrencies with up-to-the-minute<br/> 
                      updates.<br/>
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                      Track your investments in one place, analyze performance, and manage your crypto portfolio effortlessly.
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  <div
                    ...
                    style={{ boxShadow: "0 10px 28px rgba(0,0,0,.08)" }}
                  >
                    <p className="font-semibold text-xl">Market Insights</p>
                    <p className="mt-4">
                      Access comprehensive market data, including<br/> 
                      charts, trends, and analytics to make informed <br/>
                      decisions.
                    </p>
                  </div>
                </div>
